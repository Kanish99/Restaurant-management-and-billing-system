		...
		implements	ActionListener
{
	...
	private	JMenuItem	menuFileAddEmployee;
	...
	public MenuExample()
	{
		setTitle( "Restaurant Management Costing System" );
		setSize( 310, 130 );
		...
		menuFile = new JMenu( "Customer" );
		menuFile.setMnemonic( 'F' );
		menuBar.add( menuFile );

		// Create the file menu
		// Build a file menu items
		menuFileAddEmployee = CreateMenuItem( menuFile, ITEM_PLAIN,
								"Add Customer Details", null, 'N', null );
		menuFileOpen = CreateMenuItem( menuFile, ITEM_PLAIN, "Delete Customer Details",
								new ImageIcon( "delete.gif" ), 'O',
								"Open a new file" );
		...
		//menu with form brijesh
		
		menuFileAddEmployee.addActionListener(new ActionListener(){
			
				public void actionPerformed(ActionEvent e)
				{
					DeleteEmployeeDetails obj=new DeleteEmployeeDetails();
					obj.setVisible(true);
